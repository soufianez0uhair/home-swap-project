...
function HeroText({swapSearch, title, description, rentSearch, handleChange}) {
  ...
  return (
        <>
          ...
          <HouseOptions swapSearch={swapSearch} rentSearch={rentSearch} handleChange={handleChange} />
        </>
  )
}
